...
const suggestedPeople = [
  ...
  { name: "Ryan Roslansky", title: "CEO of Linkedin", img: images.people2 },
  { name: "Dylan Field", title: "CEO of Figma", img: images.people3 },
];

const events = [
  { title: "No more terrorism no more cry", day: "10", month: "Jul", going: 17, img: images.feedEvent1 },
  { title: "No more terrorism no more cry", day: "10", month: "Jul", going: 17, img: images.feedEvent1 },
];
      ...
      <div className="_layout_left_sidebar_wrap">
        ...
        <div className="_layout_left_sidebar_inner">
          <div className="_left_inner_area_suggest _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            ...
            {suggestedPeople.map(({ name, title, img }) => (
              <div key={name} className="_left_inner_area_suggest_info">
                <div className="_left_inner_area_suggest_info_box">
                  <div className="_left_inner_area_suggest_info_image">
                    <Link href="#0">
                      <Image src={img} alt={name} width={40} height={40} className="_info_img" />
                    </Link>
                  </div>
        ...
        <div className="_layout_left_sidebar_inner">
          <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            ...
            {events.map(({ title, day, month, going, img }, i) => (
              <Link key={i} className="_left_inner_event_card_link" href="#0">
                <div className="_left_inner_event_card">
                  <div className="_left_inner_event_card_iamge">
                    <Image src={img} alt={title} width={280} height={120} className="_card_img" />
                  </div>
